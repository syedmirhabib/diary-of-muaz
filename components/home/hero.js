      ...
      <div className={classes.container}>
        <div className={classes.row}>
          <div className={classes.columnLeft}>
            <h3 data-aos="fade-left">Hi, my name is Kifayat Muaz</h3>
            <h1 data-aos="fade-right">I&apos;m a Professional Runner.</h1>
            <p data-aos="fade-left" data-aos-delay="150">
              I run day and night, even in my{" "}
              <span>
                <Image
            ...
            <div className={classes.socialMedia}>
              <a
                href="https://www.facebook.com/Kifayatmuaz.official"
                target="_blank"
                rel="noreferrer"
              >
                <i className="fab fa-facebook" data-aos="flip-up"></i>
              </a>
              <a
                href="https://www.linkedin.com/in/kifayat-muaz/"
                target="_blank"
                rel="noreferrer"
              >
                <i
